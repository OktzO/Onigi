...
export const makeChatsSocket = (config) => {
    ...
    /** keyed mutex: messages are processed in order per chat, parallel across chats */
    const messageMutex = makeKeyedMutex();
    /** keyed mutex: receipts are processed in order per chat, parallel across chats */
    const receiptMutex = makeKeyedMutex();
    /** this mutex ensures that app state patches are processed in order */
    const appStatePatchMutex = makeMutex();
    /** keyed mutex: notifications are processed in order per chat, parallel across chats */
